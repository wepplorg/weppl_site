...
<link rel="shortcut icon" type="image/png" href="{{secure_asset('img/icons/fevicon.png')}}" />
...
<!-- new design custom css and js -->
  <!-- Icons-->
    <link href="{{ secure_url('assets/@coreui/icons/css/coreui-icons.min.css')}}" rel="stylesheet">
    <link href="{{ secure_url('assets/flag-icon-css/css/flag-icon.min.css')}}" rel="stylesheet">
    <link href="{{ secure_url('assets/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{ secure_url('assets/simple-line-icons/css/simple-line-icons.css')}}" rel="stylesheet">
   ...
   <!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>-->
    ...
    <script src="{{secure_url('assets/pace-progress/pace.min.js')}}"></script>
    <script src="{{secure_url('assets/perfect-scrollbar/dist/perfect-scrollbar.min.js')}}"></script>
    <script src="{{ secure_url('assets/@coreui/coreui/dist/js/coreui.min.js')}}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.11/summernote-bs4.js"></script>
     <!-- datatables -->
    <script src="https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js"></script>
    
    <script src="{{ secure_url('js/share.js') }}"></script>
