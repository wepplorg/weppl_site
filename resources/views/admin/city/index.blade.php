               ...
               <tbody>
                  ...
                  @foreach($cities as $city)
                    <tr>
                       ...
                       <td>@if($city->status == 1)<span class="badge badge-success">Active</span>@else<span class="badge badge-danger">In-Active</p>@endif</td>
                       <td>
                          <div class="row justify-content-center">
                        <a href="{{url('admin/city/'.$city->id)}}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                         &nbsp;&nbsp;
						<form action="{{url('admin/city/'.$city->id)}}" class="delete" method="POST">
