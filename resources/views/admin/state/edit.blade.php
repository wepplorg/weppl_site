...
@section('content')
  <main class="main">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"> Edit State</li>
        <!-- Breadcrumb Menu-->
                 ...
                 <div class="card-body">
                   <form action="{{url('admin/state/'.$state->id)}}" method="POST">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="state_name" value="{{$state->state_name}}" required class="form-control">
                        </div>
                        <div class="form-group">
                          <label>Status</label>
                          @if($state->status == 1)
                        ...
                        <div class="form-group">
                          ...
                          <a href="{{url('admin/state')}}" class="btn btn-danger">Cancel</a>
                        </div>
                    </div>
                   </form>
                 </div>
